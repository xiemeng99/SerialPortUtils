 ...
 * @Version 1.0.0
 **/
internal class SerialPortOld private constructor(private val context: Context){
    ...
    companion object {
         ...
         */
        private var instance: SerialPortOld ?= null
        fun getInstance(context: Context): SerialPortOld{
            val temp = instance
            if (temp != null){
                return temp
            }
            return synchronized(this) {
                ...
                if (temp2 != null) {
                    ...
                    val created = SerialPortOld(context.applicationContext)
                    instance = created
                    created
                }
            }
    ...
    * @Version 1.0.0
    */
    internal fun doDiscovery(context: Context){
        /**
         * 检查权限
         */
